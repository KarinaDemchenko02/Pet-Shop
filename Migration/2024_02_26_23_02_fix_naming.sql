...
-- Изменение названий столбцов в таблице up_product_characteristic
...
-- Изменение названий столбцов в таблице up_order_product
...
-- Изменение столбца в таблице up_shopping_session_product
ALTER TABLE up_shopping_session_product
	CHANGE COLUMN item_id product_id int not null;

-- Изменение названия столбца в таблице up_tag_product
