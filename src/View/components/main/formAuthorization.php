<div class="form__container">
	<div class="form__box">
		...
		<div class="form__login-container">
			...
			<form id="formAuthorization" method="POST" class="form__main-container">
				<div class="form__input-container">
					...
					<div class="form__input-container form__container-phone form__input-register">
						...
						<input class="form__input" type="number" id="phone" name="phone">
					</div>
				...
				<button id="login" class="form__button" type="submit">
					<div class="form__spinner spinner-border text-light" role="status">
						<span class="visually-hidden">Loading...</span>
					</div>
					<span>ВОЙТИ</span>
				</button>
				<button class="form__button form__button-register" type="submit">ЗАРЕГИСТРИРОВАТЬСЯ</button>
			</form>
		</div>
	</div>
