<li class="basket__item">
	<form class="form__delete-basket" id="basketdelete<?= $this->getVariable('id') ?>" method="post" action="/deleteFromBasket/<?= $this->getVariable('id') ?>/">
	...
	<div class="basket__quantity">
		...
		<input <?= $this->getVariable('id') ?> class="basket__input-number" type="text" name="name" value="<?=$this->getVariable('quantity')?>">
